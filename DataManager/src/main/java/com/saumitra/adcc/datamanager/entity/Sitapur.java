...
@Table(name = "SITAPUR")
@XmlRootElement
public class Sitapur implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Sitapur)) {
            return false;
        }
        Sitapur other = (Sitapur) object;
    ...
    public String toString() {
        return "com.saumitra.adcc.datamanager.entity.Sitapur[ sourceCode=" + sourceCode + " ]";
    }
